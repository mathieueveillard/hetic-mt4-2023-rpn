...
describe("Test of createStack()", () => {
  describe("Stack.push", () => {
    test("Pushing should create a new stack (immutability)", () => {
      const stack = createStack<number>();
      stack.push(0);
      expect(stack.asArray()).toEqual([]);
    });

    test("Pushing should create a new stack (new stack)", () => {
      const stack = createStack<number>();
  ...
  describe("Stack.pop many", () => {
    ...
    test("Poping should create a new stack (values)", () => {
      const stack = createStack([0, 1, 2]);
  ...
  describe("Stack.length()", () => {
    test("It should return the number of items", () => {
      const stack = createStack([0, 1]);
